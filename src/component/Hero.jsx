...
const Hero = () => {
  return (
    <section className="bg-sky-300" id="Home">
      <div className="mx-auto max-w-7xl px-4 py-4 flex flex-col sm:flex-row justify-between items-center h-4/5 ">
        <div className="flex flex-col gap-y-4">
          ...
          <p className="text-xl text-slate-600 tracking-wider max-w-xl mb-10">
